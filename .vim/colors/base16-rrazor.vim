" Base16 rrazor (https://github.com/chriskempson/base16)
" Scheme: Matt Gray http://mattgray.org/
...
hi clear
syntax reset
let g:colors_name = "base16-rrazor"
...
call <SID>hi("MatchParen",    s:gui08, s:gui02, s:cterm08, s:cterm02,  "")
...
call <SID>hi("Special",      s:gui0D, "", s:cterm0D, "", "")
call <SID>hi("SpecialChar",  s:gui08, "", s:cterm08, "", "")
call <SID>hi("Statement",    s:gui0F, "", s:cterm0F, "", "")
...
" PHP Highlighting
call <SID>hi("phpMemberSelector",  s:gui08, "", s:cterm08, "", "")
call <SID>hi("phpComparison",      s:gui0A, "", s:cterm0A, "", "")
call <SID>hi("phpParent",          s:gui08, "", s:cterm08, "", "")
...
call <SID>hi("javaScriptBraces",        s:gui08, "", s:cterm08, "", "")
call <SID>hi("javaScriptDOMMethods",    s:gui0C, "", s:cterm0C, "", "")
call <SID>hi("javaScriptDOMObjects",    s:gui0C, "", s:cterm0C, "", "")
call <SID>hi("javaScriptEndColons",     s:gui05, s:gui00, s:cterm05, s:cterm00, "")
call <SID>hi("javaScriptFuncArg",       s:gui05, s:gui00, s:cterm05, s:cterm00, "")
call <SID>hi("javaScriptFunction",      s:gui0E, "", s:cterm0E, "", "")
call <SID>hi("javaScriptLogicSymbols",  s:gui0A, "", s:cterm0A, "", "")
call <SID>hi("javaScriptNumber",        s:gui0B, "", s:cterm0B, "", "")
call <SID>hi("javaScriptParens",        s:gui08, "", s:cterm08, "", "")
